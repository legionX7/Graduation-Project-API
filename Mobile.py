...
# Get sensor values
sensor_url = f"http://{'192.168.1.100'}/"
...
def main():
    ...
    while True:
        ...
        if circles is not None:
            ...
            if smallest_circle is not None:
                ...
                # cv2.putText(frame, f"Pupil diameter: {pupil_size_mm:.2f} mm", (x - 50, y - 30),
    ...
    pupil_r = last_pupil_size  # Replace get_pupil_r_value() with the actual function or variable to obtain the value
    pupil_l = last_pupil_size  # Replace get_pupil_l_value() with the actual function or variable to obtain the value
    temp = sensor2_value  # Replace get_temp_value() with the actual function or variable to obtain the value
    heartbeat = sensor1_value  # Replace get_heartbeat_value() with the actual function or variable to obtain the value
